...
var args34570 = [];
var len__25873__auto___34574 = arguments.length;
var i__25874__auto___34575 = (0);
while(true){
if((i__25874__auto___34575 < len__25873__auto___34574)){
args34570.push((arguments[i__25874__auto___34575]));

var G__34576 = (i__25874__auto___34575 + (1));
i__25874__auto___34575 = G__34576;
continue;
} else {
}
break;
...
var G__34573 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__34573,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__34573;
}
});
...
var or__24798__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__25873__auto___34581 = arguments.length;
var i__25874__auto___34582 = (0);
while(true){
if((i__25874__auto___34582 < len__25873__auto___34581)){
args__25880__auto__.push((arguments[i__25874__auto___34582]));

var G__34583 = (i__25874__auto___34582 + (1));
i__25874__auto___34582 = G__34583;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__25881__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq34578){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__34579,G__34580,seq34578__$2);
});
...
var file = cljs.core.get.call(null,map__34587__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__34587__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__34587__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__34587,map__34587__$1,file,line,column){
return (function (p1__34584_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__34584_SHARP_));
});})(map__34587,map__34587__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__25723__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__25723__auto__,prefer_table__25724__auto__,method_cache__25725__auto__,cached_hierarchy__25726__auto__,hierarchy__25727__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__24798__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__24798__auto__)){
return or__24798__auto__;
} else {
...
var temp__4657__auto___34589 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___34589)){
var message_34590 = temp__4657__auto___34589;
cljs.core.println.call(null,message_34590);
} else {
}
...
var temp__4657__auto___34591 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___34591)){
var message_34592 = temp__4657__auto___34591;
cljs.core.println.call(null,message_34592);
} else {
}
...
var temp__4655__auto__ = (function (){var and__24786__auto__ = typeof exception.stack === 'string';
if(and__24786__auto__){
var G__34602 = exception.stack;
var G__34602__$1 = (((G__34602 == null))?null:clojure.string.split_lines.call(null,G__34602));
var G__34602__$2 = (((G__34602__$1 == null))?null:cljs.core.get.call(null,G__34602__$1,depth));
if((G__34602__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__34602__$2);
}
} else {
...
var vec__34603 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__34603,(0),null);
var column = cljs.core.nth.call(null,vec__34603,(1),null);
var vec__34606 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__34606,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__34606,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__34606,(2),null);
...
var m__$1 = (function (){var G__34610 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__34610) {
case "fail":
...
var G__34616 = (function (){var G__34615 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__34615);
} else {
return G__34615;
}
})();
...
return cljs.core.vary_meta.call(null,G__34618,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e34621){var e = e34621;
var G__34622 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__34622) {
...
var vec__34627 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__34627,(0),null);
var types = vec__34627;
...
return cljs.core.map.call(null,(function (p__34639){
var vec__34640 = p__34639;
var ns = cljs.core.nth.call(null,vec__34640,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__34640,(1),null);
return ((function (vec__34640,ns,vars__$1){
return (function (){
...
var G__34643 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__34643) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__34643,env,once_fixtures,each_fixtures,vec__34640,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__34643,env,once_fixtures,each_fixtures,vec__34640,ns,vars__$1){
return (function (){
var seq__34644 = cljs.core.seq.call(null,vars__$1);
var chunk__34645 = null;
var count__34646 = (0);
var i__34647 = (0);
while(true){
if((i__34647 < count__34646)){
var v = cljs.core._nth.call(null,chunk__34645,i__34647);
var temp__4657__auto___34649 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___34649)){
var t_34650 = temp__4657__auto___34649;
each_fixture_fn.call(null,((function (seq__34644,chunk__34645,count__34646,i__34647,t_34650,temp__4657__auto___34649,v,each_fixture_fn,G__34643,env,once_fixtures,each_fixtures,vec__34640,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_34650)));
});})(seq__34644,chunk__34645,count__34646,i__34647,t_34650,temp__4657__auto___34649,v,each_fixture_fn,G__34643,env,once_fixtures,each_fixtures,vec__34640,ns,vars__$1))
);
} else {
}

var G__34651 = seq__34644;
var G__34652 = chunk__34645;
var G__34653 = count__34646;
var G__34654 = (i__34647 + (1));
seq__34644 = G__34651;
chunk__34645 = G__34652;
count__34646 = G__34653;
i__34647 = G__34654;
continue;
} else {
var temp__4657__auto__ = cljs.core.seq.call(null,seq__34644);
if(temp__4657__auto__){
var seq__34644__$1 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__34644__$1)){
var c__25609__auto__ = cljs.core.chunk_first.call(null,seq__34644__$1);
var G__34655 = cljs.core.chunk_rest.call(null,seq__34644__$1);
var G__34656 = c__25609__auto__;
var G__34657 = cljs.core.count.call(null,c__25609__auto__);
var G__34658 = (0);
seq__34644 = G__34655;
chunk__34645 = G__34656;
count__34646 = G__34657;
i__34647 = G__34658;
continue;
} else {
var v = cljs.core.first.call(null,seq__34644__$1);
var temp__4657__auto___34659__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___34659__$1)){
var t_34660 = temp__4657__auto___34659__$1;
each_fixture_fn.call(null,((function (seq__34644,chunk__34645,count__34646,i__34647,t_34660,temp__4657__auto___34659__$1,v,seq__34644__$1,temp__4657__auto__,each_fixture_fn,G__34643,env,once_fixtures,each_fixtures,vec__34640,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_34660)));
});})(seq__34644,chunk__34645,count__34646,i__34647,t_34660,temp__4657__auto___34659__$1,v,seq__34644__$1,temp__4657__auto__,each_fixture_fn,G__34643,env,once_fixtures,each_fixtures,vec__34640,ns,vars__$1))
);
} else {
}

var G__34661 = cljs.core.next.call(null,seq__34644__$1);
var G__34662 = null;
var G__34663 = (0);
var G__34664 = (0);
seq__34644 = G__34661;
chunk__34645 = G__34662;
count__34646 = G__34663;
i__34647 = G__34664;
continue;
}
} else {
...
});})(each_fixture_fn,G__34643,env,once_fixtures,each_fixtures,vec__34640,ns,vars__$1))
);
});})(each_fixture_fn,G__34643,env,once_fixtures,each_fixtures,vec__34640,ns,vars__$1))
], null);
...
//# sourceMappingURL=test.js.map?rel=1481381471769