...
var x__25461__auto__ = (((x == null))?null:x);
var m__25462__auto__ = (sablono.util.to_str[goog.typeOf(x__25461__auto__)]);
if(!((m__25462__auto__ == null))){
return m__25462__auto__.call(null,x);
} else {
var m__25462__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__25462__auto____$1 == null))){
return m__25462__auto____$1.call(null,x);
} else {
...
var x__25461__auto__ = (((x == null))?null:x);
var m__25462__auto__ = (sablono.util.to_uri[goog.typeOf(x__25461__auto__)]);
if(!((m__25462__auto__ == null))){
return m__25462__auto__.call(null,x);
} else {
var m__25462__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__25462__auto____$1 == null))){
return m__25462__auto____$1.call(null,x);
} else {
...
var len__25873__auto___33037 = arguments.length;
var i__25874__auto___33038 = (0);
while(true){
if((i__25874__auto___33038 < len__25873__auto___33037)){
args__25880__auto__.push((arguments[i__25874__auto___33038]));

var G__33039 = (i__25874__auto___33038 + (1));
i__25874__auto___33038 = G__33039;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__25881__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq33036){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq33036));
});
...
var vec__33043 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var seq__33044 = cljs.core.seq.call(null,vec__33043);
var first__33045 = cljs.core.first.call(null,seq__33044);
var seq__33044__$1 = cljs.core.next.call(null,seq__33044);
var first_word = first__33045;
var words = seq__33044__$1;
...
var G__33047 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__33047,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys);
} else {
return G__33047;
}
} else {
...
return clojure.string.join.call(null," ",cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__33048_SHARP_){
if(typeof p1__33048_SHARP_ === 'string'){
return p1__33048_SHARP_;
} else {
return cljs.core.seq.call(null,p1__33048_SHARP_);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__24798__auto__ = x__$1.hasDomain();
...
//# sourceMappingURL=util.js.map?rel=1481381470652